		...
		<section class="bg-white dark:bg-gray-900">
		  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
		      ...
		      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
		          <div class=" cursor-pointer " id="templateSettingsButton" >
		              ...
		              <h3 class="mb-2 text-xl font-bold dark:text-white">Template Excel</h3>
		              <p class="text-gray-500 dark:text-gray-400">Ubah template format excel yang digunakan pada aplikasi.</p>
		          </div>
		          <div>
		              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
...
@section('script')
	<script>
		const templateSettingsButton = document.getElementById('templateSettingsButton');
