...
@if(session()->get('success'))
	<div id="alert-3" class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
	  ...
	  <div class="ms-3 text-sm font-medium">
	    Pengajuan seminar hasil berhasil
	  </div>
	...
	<div class="w-full h-full grid gap-4 lg:grid-cols-4" >
		...
		<section class="bg-white dark:bg-gray-900 px-3 lg:col-span-2">
		  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
		      <h2 class="text-xl font-bold text-gray-900 dark:text-white">Pengajuan seminar Hasil</h2>
